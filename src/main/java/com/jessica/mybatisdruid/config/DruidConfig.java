package com.jessica.mybatisdruid.config;
...
@Slf4j
@Configuration
@MapperScan(basePackages= {"com.jessica.mybatisdruid.mapper"},sqlSessionTemplateRef = "funSqlSessionTemplate")
public class DruidConfig {
	Logger log = LoggerFactory.getLogger(DruidConfig.class);
	@Autowired
    private Environment env;
    @Autowired
    private DruidConfigProperties druidProperties;//spring.datasource.fun
...
//                .getResources(env.getProperty("mybatis.mapper.locations.fun")));
        fb.setTypeAliasesPackage("com.jessica.mybatisdruid.mapper");
...
//    @Bean(name = "funSqlSessionTemplate")
    ...
    public ServletRegistrationBean statViewServlet(){
        ...
        initParams.put("allow","10.100.16.21");//默认就是允许所有访问
        initParams.put("deny","10.100.16.21");
